    ...
    <footer ref={footerRef} className="bg-black text-white font-sans pt-12 md:pt-20 border-t border-white h-screen flex flex-col">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex flex-col gap-1">
          ...
          <p className="font-sans text-xs md:text-sm font-medium uppercase tracking-wide leading-relaxed text-white/60">
            Andhra Pradesh, India [Lat: 15.9, Long: 79.7]
          </p>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="flex flex-col gap-1">
          ...
          <div className="flex flex-col gap-2">
            <a
              href="mailto:karthikeyamanam9@gmail.com"
            ...
            <a
              href="https://www.linkedin.com/in/karthikeya-manam-752a42375/"
              target="_blank"
            ...
            <a
              href="https://github.com/ManamKarthikeya"
              target="_blank"
              rel="noopener noreferrer"
              className="font-sans text-xs md:text-sm font-medium uppercase tracking-wide hover:underline underline-offset-4 decoration-1 w-fit flex items-center gap-1"
            >
      ...
      >
        <h1 className="font-sans font-black text-[10vw] md:text-[14vw] leading-[0.8] text-white uppercase tracking-tighter flex items-start">
          Karthikeya
          <span className="text-xl md:text-3xl lg:text-5xl font-medium mt-[1vw] ml-1 opacity-60">
            ®
          </span>
        </h1>
      </motion.div>
