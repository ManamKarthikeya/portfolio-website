...
const SocialStrip = () => {
  const socials = [
    { label: "GitHub", href: "https://github.com/ManamKarthikeya" },
    { label: "LinkedIn", href: "https://www.linkedin.com/in/karthikeya-manam-752a42375/" },
    { label: "Email", href: "mailto:karthikeyamanam9@gmail.com" },
  ];
  return (
    <motion.div
...
const MobileSocialStrip = () => {
  const socials = [
    { label: "Github", icon: Github, href: "https://github.com/ManamKarthikeya" },
    { label: "LinkedIn", icon: Linkedin, href: "https://www.linkedin.com/in/karthikeya-manam-752a42375/" },
    { label: "Email", icon: Mail, href: "mailto:karthikeyamanam9@gmail.com" },
  ];
  return (
    <motion.div
      initial={{ opacity: 0, x: 20 }}
        ...
        <div className="z-10 grid grid-cols-1 md:grid-cols-12 w-full gap-4 mb-8 md:mb-0">
          ...
          >
            ...
            <p className="font-sans text-xs md:text-sm font-medium text-white leading-relaxed tracking-wide uppercase text-left">
              Creating intelligent systems and modern web experiences that solve real-world problems.
            </p>
          </motion.div>
        </div>
      </section>
