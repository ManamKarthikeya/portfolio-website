...
const projects = [
  {
    ...
    description: "A no-code website builder with real-time editing, dynamic content updates, and clean export functionality for production-ready websites.",
    links: { live: "#", code: "#" },
    image: "/p1_new.png",
    cta: "Live Project"
  },
  {
    ...
    description: "An interactive 3D portfolio with smooth animations, scroll-based transitions, and immersive user experience built using modern web technologies.",
    links: { live: "#", code: "#" },
    image: "/p2_new.png",
    cta: "Live Project"
  },
  {
    id: "003",
    title: "KVK FASHION E-COMMERCE",
    stack: "HTML / CSS / JavaScript / PHP / MySQL",
    description: "A full-stack fashion e-commerce platform with product pages, cart system, and responsive UI designed for real-world usability.",
    links: { live: "#", code: "#" },
    image: "/p3_new.png",
    cta: "Live Project"
  },
  {
    id: "004",
    title: "AI SMART ASSISTANT (JARVIS)",
    stack: "Python / AI APIs / Speech Recognition",
    description: "A voice-controlled AI assistant capable of executing tasks, opening apps, and interacting with users in real-time.",
    links: { live: "#", code: "#" },
    image: "/p4_new.png",
    cta: "Live Project"
  }
