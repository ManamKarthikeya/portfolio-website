...
const skillCategories = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "XAMPP", url: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/apache/apache-original.svg" }
    ]
  },
  {
    link: "#",
    ...
    items: [
      ...
      { name: "Node.js (Basics)", url: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nodejs/nodejs-original.svg" },
        ...
        >
          ...
          <div className="md:col-span-4">
            <blockquote className="text-3xl md:text-5xl lg:text-6xl xl:text-7xl font-black uppercase leading-tight">
              “I build systems that turn complex ideas into simple, usable experiences.”
            </blockquote>
            <p className="mt-6 font-bold uppercase tracking-widest text-sm">— Karthikeya</p>
          </div>
        </motion.div>
      </div>
